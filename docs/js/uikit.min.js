!function (t) {
    ...
    t.component("stackMargin", {
        defaults: {cls: "uk-margin-small-top", rowfirst: !1}, boot: function () {
            ...
            var i = this, e = this.element.children();
    ...
    var i = {x: window.scrollX, y: window.scrollY}, e = (t.$win, t.$doc, t.$html), n = {
        show: function (n) {
            if (n = t.$(n), n.length) {
                var o = t.$("body"), s = n.find(".uk-offcanvas-bar:first"), a = "right" == t.langdirection,
    ...
    t.component("switcher", {
        ...
        show: function (n, o) {
            if (!this.animating) {
                ...
                var a = this, s = this.find(this.options.toggle), r = t.$(n),
